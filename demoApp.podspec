#
#  Be sure to run `pod spec lint demoApp.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "demoApp"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of demoApp."
  ...
  spec.source       = { :git => "https://github.com/Azharuddin-9446/cocoapodsDemo.git", :tag => "#{spec.version}" }
...
spec.source_files  = "AccuraOCR.framework", "AccuraOCR.framework/**/*.{h,m}"
...
spec.vendored_frameworks = 'AccuraOCR.framework'
 ...
 spec.xcconfig   = { 'HEADER_SEARCH_PATHS' => '$(SRCROOT)/leveldb/ $(SRCROOT)/leveldb/include' }
